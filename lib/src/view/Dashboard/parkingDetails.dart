...
class parkingDetails extends StatefulWidget {
  ...
  const parkingDetails({Key? key, required this.cardId, required this.vehicleNo}) : super(key: key);
...
class _parkingDetailsState extends State<parkingDetails> {
  ...
  String timeDifference(String time1, String time2) {
    ...
    if (time1 != '' && time2 != '') {
      ...
      difference = Duration(hours: 0, minutes: 0);
    }
   String duration = formatDuration(difference);
      ...
      body: SingleChildScrollView(
        child: Padding(
          padding: EdgeInsets.only(
              bottom: MediaQuery.of(context).viewInsets.bottom), // adjust padding for height of keyboard,
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Stack(children: [
                SvgPicture.asset(rectangleCurve,
                      ...
                      itemBuilder: (c, index) {
                        return InkWell(
                            ...
                            child: parkingDetailListView(
                              ...
                              totalTime:
                                  "${timeDifference(snapshot.data![index].timeIn, snapshot.data![index].timeOut)}",
